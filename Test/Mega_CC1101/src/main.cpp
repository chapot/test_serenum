...
#include "../lib/RCSwitch-CC1101/ELECHOUSE_CC1101_RCS_DRV.h"
#include <RCSwitch.h>
...
//CC1101 Settings:  
  ...
  ELECHOUSE_cc1101.freq2(0x10); //set your own frequency Parameters Freq2. From Smart RF Studio. Must set Frequency settings F_xxx.
  ELECHOUSE_cc1101.freq1(0xB0); //set your own frequency Parameters Freq1. From Smart RF Studio. Must set Frequency settings F_xxx.
  ELECHOUSE_cc1101.freq0(0x71); //set your own frequency Parameters Freq0. From Smart RF Studio. Must set Frequency settings F_xxx.
